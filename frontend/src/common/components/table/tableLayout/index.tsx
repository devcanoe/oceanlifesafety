                ...
                { props.data.map((d: Data)=> {
                    ...
                    <div className={styles.gridcontainer}>
                        ...
                        <div className={styles.gridthumbnail}>
                            {
                                d.type === "folder" && <Icon icon="material-symbols:folder" height={40} width={40} />
                            }
                            {
                                d.type === "file" && <Icon icon="mdi:file-outline" height={40} width={40} />
                            }
                            {
                                d.type === "pdf" && <Icon icon="teenyicons:pdf-solid" height={40} width={40} />
                            }
                            {
                                d.type === "excel" && <Icon icon="file-icons:microsoft-excel" height={40} width={40} />
                            }
                        </div>
                    </div>
                    </>)
                ...
                return (<>
                    <div className={styles.listcontainer}>
                        <div className={styles.listdetail}>
                            ...
                            {
                                d.type === "excel" && <Icon icon="file-icons:microsoft-excel" />
                            }
                            {
                                d.type === "folder" && <Icon icon="material-symbols:folder" />
                            }
                            {
