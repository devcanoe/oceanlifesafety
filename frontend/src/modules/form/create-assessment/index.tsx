...
import { useCreateBACLMutation, useCreateEEPDMutation } from "@/common/services/form.service";
import SToast from "@/common/components/display/toast/toast";
import { IHandleMotion } from "@/common/components/display/popup";
import { useRouter } from "next/router";

interface ICreateBACL {
    companyId: string
}

export default function CreateAssessmentContent(props: ICreateBACL) {
    ...
    const [testingBar, setTestingbar] = useState<string>();
    ...
    const { data, isLoading, isSuccess}  = useGetAllShipsQuery({id: props.companyId});
    ...
    const [ createBACL, { isLoading: eepdLoading}] = useCreateBACLMutation();
            ...
            <section className={styles.container}>
                ...
                <div className={styles.container}>
                    ...
                    <InputField 
                        ...
                        helperText={
                        formik.touched.location_of_vessel && formik.errors.location_of_vessel
                        }
                    />
                    <InputField 
                        type={"date"} 
                    ...
                    <InputField 
                        ...
                        onChange={formik.handleChange}
                        error={
                          formik.touched.flag_state &&
                          Boolean(formik.errors.flag_state)
                        }
                        helperText={
                          formik.touched.flag_state && formik.errors.flag_state
                        }
                    />
                    <InputField 
                        type={"date"} 
                    ...
                    <div className={styles.main}>
                        ...
                        <div className={styles.input}>
                            ...
                            <InputField 
                                ...
                                placeholder=""
                                value={dateHydTested}
                                onChange={(e: any) => { setDateHydTested(e.target.value)}}
                            />
                        </div>
                        <div className={styles.input}>
                            <small>Cylinder condition</small>
                            <InputField
                                ...
                                onChange={(e: any) => { setCylinderCondition(e.target.value)}}
                            />
                        </div>
                        <div className={styles.input}>
                            <small>Testing bar</small>
                            <InputField
                                ...
                                placeholder=""
                                value={testingBar}
                                onChange={(e: any) => { setTestingbar(e.target.value)}}
                            />
                        </div>
                        <div className={styles.input}>
                            <small>Refilling bar</small>
                            <InputField
                                ...
                                placeholder=""
                                value={refilingBar}
                                onChange={(e: any) => { setRefilingBar(e.target.value)}}
                            />
                        </div>
                        <div className={styles.input}>
                            <small>Remark</small>
                ...
                <div>
                    <Button label="Submit" isLoading={eepdLoading} onClick={formik.handleSubmit}/>
                </div>
                <SToast
