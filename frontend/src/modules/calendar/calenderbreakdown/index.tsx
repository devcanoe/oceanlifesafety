...
export function Breakdown({children, type}: IBreakdown) {
    return (
        <>
            <div className={type === "servicing" ? styles.breakdownservicecontainer : styles.breakdowntaskcontainer}>
                { children}
            </div>
        </>
    )
    ...
    return (
        <>
            <div className={styles.taskcontainer}>
                ...
                <div className={showDescription ? styles.hidedescription: styles.showdescription}>
