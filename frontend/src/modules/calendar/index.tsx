...
export default function CalendarSection() {
    ...
    const [addServicingModalStatus, setAddServicingModalStatus] = useState<boolean>(false);
            ...
            <div className={styles.container}>
                <div className={styles.calendarcontainer}>
                    ...
                    <div className={styles.dropdown}>
                        <span className={styles.dropdownbutton}>Create <Icon icon="teenyicons:down-solid" color="black" /></span>
                        <div className={styles.dropdowncontent}>
                            <p className={styles.dropdowncontentitem} onClick={createTaskHandler}>Task</p>
                            <p className={styles.dropdowncontentitem} onClick={createServicingHandler}>Servicing</p>
                        </div>
                    </div>
                ...
                <Popup displayStatus={addServicingModalStatus} close={createServicingHandler}>
