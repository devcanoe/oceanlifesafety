...
import { useCreateTypeMutation, useGetTypeQuery, useUpdateTypeMutation } from '@/common/services/ticket.service';
    ...
    return (
        <>
            <section className={styles.container}>
                ...
                />
                <Button isLoading={isLoading} label={'Add Type'} onClick={formik.handleSubmit}/>
            </section>
        ...
        <>
            ...
            <section className={styles.container}>
                <InputField
                    ...
                    helperText={formik.touched.name && formik.errors.name}
                />
                <Button  isLoading={loadingType} label={'Update Type'} onClick={formik.handleSubmit}/>
            </section>
        </>
    )
}