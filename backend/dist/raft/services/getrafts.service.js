...
let GetRaftsService = class GetRaftsService {
    constructor(httpHelper, raftRepository) {
    ...
    execute(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                console.log(id);
                const data = yield this.raftRepository.fetchData({ company: id });
                console.log(data);
