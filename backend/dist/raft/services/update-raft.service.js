...
let UpdateRaftService = class UpdateRaftService {
    constructor(httpHelper, raftRepository, logRepository) {
    ...
    execute(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const { user } = req.body;
                const data = yield this.raftRepository.updateData({ _id: id }, req.body);
