...
let RaftController = class RaftController {
    ...
    createRaft(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.createRaftService.execute(req, res);
        });
    }
    deleteRaft(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.deleteRaftService.execute(req, res);
        });
    }
    getRafts(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getRaftsService.execute(req, res);
        });
    }
    getRaft(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getRaftService.execute(req, res);
        });
    }
    updateRaft(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.updateRaftService.execute(req, res);
        });
    }
};
