...
let FetchCompanyService = class FetchCompanyService {
    constructor(companyRepository, httpHelper) {
    ...
    execute(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const data = yield this.companyRepository.fetchOneData({ _id: id });
