...
let CompanyController = class CompanyController {
    ...
    createCompany(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.createCompanyService.execute(req, res);
        });
    }
    fetchCompany(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.fetchCompanyService.execute(req, res);
        });
    }
    fetchCompanies(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.fetchCompaniesService.execute(req, res);
        });
    }
    deleteCompany(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.deleteCompanyService.execute(req, res);
        });
    }
    updateCompany(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.updateCompanyService.execute(req, res);
        });
    }
};
