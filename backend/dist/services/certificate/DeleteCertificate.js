...
let DeleteCertificate = class DeleteCertificate {
    ...
    execute(req) {
        return __awaiter(this, void 0, void 0, function* () {
            // delete file from s3
            yield this.fileService.deleteFile(req);
            // delete file from db table
            return yield this.fileRepository.deleteFile(req.body.id);
        });
    }
};
DeleteCertificate = __decorate([
    (0, tsyringe_1.injectable)(),
    __metadata("design:paramtypes", [FileRepository_1.default,
        FileService_1.default])
], DeleteCertificate);
exports.default = DeleteCertificate;
