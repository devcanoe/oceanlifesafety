...
let CreatePFECLService = class CreatePFECLService {
        ...
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                yield this.logRepository.addData({
                    description: `${user.email} created pfecl form`,
                    user: user._id
                });
                this.httpHelper.Response({
                    res,
                    status: "success",
                    message: "Successfully create pfecl",
                    data: createForm
                });
            }
            catch (err) {
