...
let FormController = class FormController {
    ...
    createEEBD(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.createEEPDService.execute(req, res);
        });
    }
    createBACL(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.createBACLService.execute(req, res);
        });
    }
    createPFECL(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.createPFECLService.execute(req, res);
        });
    }
    getForms(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getFormsService.execute(req, res);
        });
    }
    getForm(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.getFormService.execute(req, res);
        });
    }
    deleteForm(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.deleteFormService.execute(req, res);
        });
    }
    updateForm(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.updateFormService.execute(req, res);
        });
    }
};
