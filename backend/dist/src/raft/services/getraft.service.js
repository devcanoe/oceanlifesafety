...
let GetRaftService = class GetRaftService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const data = yield this.raftRepository.fetchOneData({ _id: id });
