...
let CreateRaftService = class CreateRaftService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield this.raftRepository.addData(req.body);
