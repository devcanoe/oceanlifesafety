...
let InvoiceController = class InvoiceController {
    ...
    generateInvoice(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.generaateInvoiceService.execute(req, res, next);
        });
    }
    fetchInvoices(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.fetchInvoicesService.execute(req, res, next);
        });
    }
    fetchInvoice(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.fetchInvoiceService.execute(req, res, next);
        });
    }
    deleteInvoice(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.deleteInvoiceService.execute(req, res, next);
        });
    }
    deleteInvoiceItem(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.deleteInvoiceItemService.execute(req, res, next);
        });
    }
};
