...
let FetchCompaniesService = class FetchCompaniesService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const data = yield this.companyRepository.fetchData({});
