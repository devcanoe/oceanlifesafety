    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const company = yield this.companyRepository.fetchOneData({ name });
                if (company) {
                    throw new badrequest_error_1.BadRequestError("Company name already taken");
                }
                const createCompany = yield this.companyRepository.addData(req.body);
