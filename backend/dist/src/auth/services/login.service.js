    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                if (!user) {
                    throw new badrequest_error_1.BadRequestError("Invalid email/password");
                }
                // //compare encrypted password
                const checkpassword = yield this.encryptionHelper.compareHash(password, (user === null || user === void 0 ? void 0 : user.password) ? user.password : '');
                if (!checkpassword) {
                    throw new badrequest_error_1.BadRequestError("Invalid email/password");
                }
