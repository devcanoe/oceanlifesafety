...
let UpdateServicingService = class UpdateServicingService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                const updateServicing = yield this.calendarRepository.updateData({ _id: id }, req.body);
...
UpdateServicingService = __decorate([
    (0, tsyringe_1.injectable)(),
    __metadata("design:paramtypes", [calendar_repository_1.default,
        http_helper_1.default])
], UpdateServicingService);
exports.default = UpdateServicingService;
