...
let DeleteServicingService = class DeleteServicingService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                const { id } = req.params;
                yield this.calendarRepository.deleteData(id);
                this.httpHelper.Response({
                    res,
                    status: "success",
                    message: "successfully delete servicng",
                });
            }
            catch (err) {
                next(err);
...
DeleteServicingService = __decorate([
    (0, tsyringe_1.injectable)(),
    __metadata("design:paramtypes", [calendar_repository_1.default,
        http_helper_1.default])
], DeleteServicingService);
exports.default = DeleteServicingService;
