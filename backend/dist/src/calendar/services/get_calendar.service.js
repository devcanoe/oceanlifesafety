...
let GetCalendarService = class GetCalendarService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                let result = [];
                if (task) {
                    result = yield this.calendarRepository.fetchData({ type: "TASK" });
                }
                else if (servicing) {
                    result = yield this.calendarRepository.fetchData({ type: "SERVICING" });
                }
                else {
                    result = yield this.calendarRepository.fetchData({});
                }
