...
let AddServicingService = class AddServicingService {
    ...
    execute(req, res, next) {
        return __awaiter(this, void 0, void 0, function* () {
            try {
                ...
                const addTask = yield this.calendarRepository.addData({
                    type: "SERVICING",
                    due_date,
                    vessel,
                    company
