...
let ShipController = class ShipController {
    ...
    createShip(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.createShipService.execute(req, res);
        });
    }
    fetchShip(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.fetchShipService.execute(req, res);
        });
    }
    fetchShips(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.fetchShipsService.execute(req, res);
        });
    }
    deleteShip(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.deleteShipService.execute(req, res);
        });
    }
    updateShip(req, res) {
        return __awaiter(this, void 0, void 0, function* () {
            yield this.updateShipService.execute(req, res);
        });
    }
};
