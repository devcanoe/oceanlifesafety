...
const user_repository_1 = __importDefault(require("../src/common/database/repository/user.repository"));
const app_1 = __importDefault(require("../src/app"));
const tsyringe_1 = require("tsyringe");
const encrypt_helper_1 = __importDefault(require("../src/common/helper/encrypt.helper"));
describe('', () => {
    let mongod;
    let userRepository;
